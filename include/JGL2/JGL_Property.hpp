...
struct Property : Widget {
	...
	virtual glm::dim2	actionSize() const { return _actionSz; }
	...
	virtual void		actionSize(const glm::dim2& sz);
	virtual void		actionAlignment(int a);
protected:
	
	Property(float x, float y, float w, float h, const string& label="");
	Property(const glm::vec2& pos, const glm::dim2& sz, const string& label="");
	...
	virtual glm::dim2	minActionSize(NVGcontext* vg) const = 0;
	virtual void		drawAction(NVGcontext* vg, const glm::rect& r, int alignment)=0;
