...
struct ButtonGroup: public Aligner {
	...
	ButtonGroup(const glm::vec2& pos, const glm::dim2& sz, const std::string& label="ButtonGroup" );
	ButtonGroup(const glm::vec2& pos, float w, const std::string& label="ButtonGroup" );
