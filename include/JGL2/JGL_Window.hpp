...
struct Window : public Group, public _PopupHandler {
	...
	Window( const glm::dim2& sz, const std::string& title );
	virtual void		enableHDR();
	virtual glm::vec3	windowGamma() const;
	virtual glm::mat3	windowColorMat() const;
	...
	virtual glm::idim2	getWindowSize() const override;
...
protected:
	...
	glm::vec3		_windowGamma	= glm::vec3(2.4f);
	glm::mat3		_windowColorMat	= glm::mat3(1);
	...
	glm::dim2		_lastRenderSz   = glm::dim2(0,0);
	friend _JGL;
