...
struct OptionButton: public Button {
	...
	OptionButton(const glm::vec2& pos, const glm::dim2& sz, const std::string& l="" );
	OptionButton(const glm::vec2& pos, float w, const std::string& l="" );
	OptionButton(const glm::vec2& pos, const std::string& l="" );
