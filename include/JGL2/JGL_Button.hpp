...
struct Button: public Widget, public _Valued<bool> {
	...
	Button(const glm::vec2& pos, const glm::dim2& sz, const std::string& l="" );
	Button(const glm::vec2& pos, float w, const std::string& l="" );
	Button(const glm::vec2& pos, const std::string& l="" );
