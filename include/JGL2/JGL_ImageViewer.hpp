...
struct ImageViewerBase: public Widget, public _Targettable {
	...
	virtual glm::idim2 imageSize() const = 0;
	...
	virtual glm::rect	getScreenRect( const glm::rect& rect ) const;
	virtual glm::irect 	getScreenRect( const glm::irect& rect ) const;
	...
	virtual glm::rect	getScreenRect( const glm::rect& rect, const glm::vec2& offset ) const;
	virtual glm::irect 	getScreenRect( const glm::irect& rect, const glm::vec2& offset ) const;
	virtual bool 		zoomAction( const glm::vec2& mousePt, float zoomDelta );
...
struct TexImage {
	...
	glm::idim2 texSize() const { return glm::idim2(_texWidth,_texHeight); }
	//! \Brief The current user-sent image size.
	//! \Return The size of the user-sent image.
	glm::idim2 imgSize() const { return glm::idim2(_imageWidth,_imageHeight); }
...
struct ImageViewer: public ImageViewerBase {
	...
	virtual glm::idim2 imageSize() const override { return _texImage.imgSize(); };
