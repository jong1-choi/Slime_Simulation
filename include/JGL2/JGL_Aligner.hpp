...
struct Aligner : public LinearGroup {
	...
	Aligner(const glm::vec2& pos, const glm::dim2& sz, const std::string& t="Aligner" );
	Aligner(const glm::dim2& sz, const std::string& t="Aligner" );
...
protected:
	...
	virtual void fitAllChildren(NVGcontext* vg, const glm::rect& r);
	virtual void alignChildren(NVGcontext* vg, const glm::rect& r);
	virtual bool checkResizable();
	virtual void rearrangeChildren(NVGcontext* vg, const glm::rect& r, int scaling) override;
