...
extern void drawObject(const std::vector<glm::vec3>& v, const std::vector<glm::vec3>& n, const std::vector<glm::uvec3>& f, glm::vec3 p, glm::vec4 color);
extern void drawQuad( const glm::vec3& p, const glm::vec3& n, const glm::vec2& sz, const glm::vec4 color = glm::vec4(0,0,.4,1) );
extern void drawSphere( const glm::vec3& p, float r, const glm::vec4 color = glm::vec4(0.1,0.1,1,1) );
